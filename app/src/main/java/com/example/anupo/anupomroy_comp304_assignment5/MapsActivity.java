...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng Tronto = new LatLng(43.7787474, -79.255786);
        mMap.addMarker(new MarkerOptions().position(Tronto).title("Toronto").snippet("Checking the Marker"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(Tronto));
